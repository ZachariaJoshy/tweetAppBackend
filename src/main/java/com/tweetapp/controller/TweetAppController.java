...
import com.tweetapp.helperClass.likeTweetRequestClass;
...
public class TweetAppController {
	...
	public Tweet likeTweet(@RequestBody likeTweetRequestClass likeTweetObj) {
		return tweetService.likeTweet(likeTweetObj.getUsername(),likeTweetObj.getId());
	}
